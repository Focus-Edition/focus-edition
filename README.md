...
Demo mission on a phone

Try it
Open https://focus-edition-v2.netlify.app/
Click "Use demo account (1 click)"
My Editions → click any edition card (no toast)
Click any mission row → opens mission detail
Check quiz: "unique to this mission" — different per mission
Flashcards: different per mission
Listen → click again to stop
Tech
...
Roadmap
 Access to Work demo edition (13 missions) — v1
 Full-stack app with upload — v2-v4
 Missions open guaranteed + TTS toggle — v4
 Unique missions + no ID collision — v5
 No spam toasts + unique Q&A per mission — v6 (current)
...
Access to Work content: © Crown copyright, reused under the Open Government Licence v3.0. This is an unofficial adaptation; check GOV.UK for the authoritative text.
About this repo
